...
namespace Assets._Project.Develop.Runtime.UI.Gameplay.ResultPopups
{
	public class DefeatPopupPresenter : PopupPresenterBase
	{
		...
		{
			_coroutinesPerformer.StartCoroutine(_sceneSwitcher.ProcessSwitchTo(Scenes.MainMenu));
			Close();
		}

		private void OnRestartClicked()
		{
			_coroutinesPerformer.StartCoroutine(_sceneSwitcher.ProcessSwitchTo(Scenes.Gameplay, new GameplayInputArgs(_currentLevelArgs.LevelNumber)));
			Close();
		}
	}
}
