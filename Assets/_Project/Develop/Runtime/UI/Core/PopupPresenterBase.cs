...
namespace Assets._Project.Develop.Runtime.UI.Core
{
    public abstract class PopupPresenterBase : IPresenter
    {
        ...
        public void Show()
        {
            ...
            _process = _coroutinesPerformer.StartCoroutine(ProcessShow());
        }
        ...
        public void Hide(Action callback = null)
        {
            ...
            _process = _coroutinesPerformer.StartCoroutine(ProcessHide(callback));
        }
        ...
        {
            if (_process != null)
                _coroutinesPerformer.StopCoroutine(_process);
        }
    }
}
