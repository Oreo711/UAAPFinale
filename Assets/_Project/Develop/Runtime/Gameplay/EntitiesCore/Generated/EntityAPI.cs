namespace Assets._Project.Develop.Runtime.Gameplay.EntitiesCore
{
	public partial class Entity
	{
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.SpawnInitialTime SpawnInitialTimeC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.SpawnInitialTime>();
		...
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.SpawnInitialTime component);
			if(result)
				value = component.Value;
			else
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.SpawnInitialTime() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.SpawnInitialTime() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.SpawnCurrentTime SpawnCurrentTimeC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.SpawnCurrentTime>();
		...
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.SpawnCurrentTime component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.SpawnCurrentTime() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.SpawnCurrentTime() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.InSpawnProcess InSpawnProcessC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.InSpawnProcess>();
		...
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.InSpawnProcess component);
			if(result)
				value = component.Value;
			else
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.InSpawnProcess() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Boolean>() }); 
		}
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Spawn.InSpawnProcess() {Value = value}); 
		}
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.LifeCycle.HealOnWaveStart HealOnWaveStartC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.LifeCycle.HealOnWaveStart>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> HealOnWaveStart => HealOnWaveStartC.Value;

		public bool TryGetHealOnWaveStart(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.LifeCycle.HealOnWaveStart component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddHealOnWaveStart()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.LifeCycle.HealOnWaveStart() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddHealOnWaveStart(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.LifeCycle.HealOnWaveStart() {Value = value}); 
		}
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.LifeCycle.MarkedForDeath MarkedForDeathC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.LifeCycle.MarkedForDeath>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Boolean> MarkedForDeath => MarkedForDeathC.Value;

		public bool TryGetMarkedForDeath(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Boolean> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.LifeCycle.MarkedForDeath component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Boolean>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddMarkedForDeath()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.LifeCycle.MarkedForDeath() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Boolean>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddMarkedForDeath(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Boolean> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.LifeCycle.MarkedForDeath() {Value = value}); 
		}
		...
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ExplosionDamage component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ExplosionDamage() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ExplosionDamageMultiplier ExplosionDamageMultiplierC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ExplosionDamageMultiplier>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> ExplosionDamageMultiplier => ExplosionDamageMultiplierC.Value;

		public bool TryGetExplosionDamageMultiplier(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ExplosionDamageMultiplier component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddExplosionDamageMultiplier()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ExplosionDamageMultiplier() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddExplosionDamageMultiplier(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ExplosionDamageMultiplier() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ModifiedExplosionDamage ModifiedExplosionDamageC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ModifiedExplosionDamage>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> ModifiedExplosionDamage => ModifiedExplosionDamageC.Value;

		public bool TryGetModifiedExplosionDamage(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ModifiedExplosionDamage component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddModifiedExplosionDamage()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ModifiedExplosionDamage() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddModifiedExplosionDamage(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.ModifiedExplosionDamage() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.BlastRadius BlastRadiusC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.BlastRadius>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> BlastRadius => BlastRadiusC.Value;

		public bool TryGetBlastRadius(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.BlastRadius component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddBlastRadius()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.BlastRadius() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddBlastRadius(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.BlastRadius() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.WorldPointExplosionRequest WorldPointExplosionRequestC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.WorldPointExplosionRequest>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> WorldPointExplosionRequest => WorldPointExplosionRequestC.Value;

		public bool TryGetWorldPointExplosionRequest(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.WorldPointExplosionRequest component);
			if(result)
				value = component.Value;
			else
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddWorldPointExplosionRequest()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.WorldPointExplosionRequest() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddWorldPointExplosionRequest(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.WorldPointExplosionRequest() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.WorldPointExplosionEvent WorldPointExplosionEventC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.WorldPointExplosionEvent>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> WorldPointExplosionEvent => WorldPointExplosionEventC.Value;

		public bool TryGetWorldPointExplosionEvent(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.WorldPointExplosionEvent component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddWorldPointExplosionEvent()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.WorldPointExplosionEvent() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddWorldPointExplosionEvent(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.WorldPointExplosionEvent() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.KamikazeExplosionRequest KamikazeExplosionRequestC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.KamikazeExplosionRequest>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent KamikazeExplosionRequest => KamikazeExplosionRequestC.Value;

		public bool TryGetKamikazeExplosionRequest(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.KamikazeExplosionRequest component);
			if(result)
				value = component.Value;
			else
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddKamikazeExplosionRequest()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.KamikazeExplosionRequest() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddKamikazeExplosionRequest(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Explosion.KamikazeExplosionRequest() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.MineDeployRequest MineDeployRequestC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.MineDeployRequest>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> MineDeployRequest => MineDeployRequestC.Value;

		public bool TryGetMineDeployRequest(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.MineDeployRequest component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddMineDeployRequest()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.MineDeployRequest() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddMineDeployRequest(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.MineDeployRequest() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.SentryDeployRequest SentryDeployRequestC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.SentryDeployRequest>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> SentryDeployRequest => SentryDeployRequestC.Value;

		public bool TryGetSentryDeployRequest(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.SentryDeployRequest component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddSentryDeployRequest()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.SentryDeployRequest() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddSentryDeployRequest(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.SentryDeployRequest() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.PuddleDeployRequest PuddleDeployRequestC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.PuddleDeployRequest>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> PuddleDeployRequest => PuddleDeployRequestC.Value;

		public bool TryGetPuddleDeployRequest(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.PuddleDeployRequest component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddPuddleDeployRequest()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.PuddleDeployRequest() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddPuddleDeployRequest(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveEvent<UnityEngine.Vector3> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.PuddleDeployRequest() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.CurrentDeployable CurrentDeployableC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.CurrentDeployable>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.Deployables> CurrentDeployable => CurrentDeployableC.Value;

		public bool TryGetCurrentDeployable(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.Deployables> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.CurrentDeployable component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.Deployables>);
			return result;
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddCurrentDeployable()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.CurrentDeployable() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.Deployables>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddCurrentDeployable(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.Deployables> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Deploy.CurrentDeployable() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.DamageOverTime.DamagePerTick DamagePerTickC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.DamageOverTime.DamagePerTick>();
		...
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.DamageOverTime.DamagePerTick component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.DamageOverTime.DamagePerTick() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}
		...
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.DamageOverTime.DamagePerTick() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.DamageOverTime.TicksPerSecond TicksPerSecondC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.DamageOverTime.TicksPerSecond>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> TicksPerSecond => TicksPerSecondC.Value;

		public bool TryGetTicksPerSecond(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.DamageOverTime.TicksPerSecond component);
			if(result)
				value = component.Value;
			else
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddTicksPerSecond()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.DamageOverTime.TicksPerSecond() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddTicksPerSecond(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Int32> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.DamageOverTime.TicksPerSecond() {Value = value}); 
		}
		...
		public Assets._Project.Develop.Runtime.Gameplay.Features.Attack.DamageToSpawnedEnemies DamageToSpawnedEnemiesC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Attack.DamageToSpawnedEnemies>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> DamageToSpawnedEnemies => DamageToSpawnedEnemiesC.Value;

		public bool TryGetDamageToSpawnedEnemies(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Attack.DamageToSpawnedEnemies component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>);
		...
		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddDamageToSpawnedEnemies()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Attack.DamageToSpawnedEnemies() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddDamageToSpawnedEnemies(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<System.Single> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Attack.DamageToSpawnedEnemies() {Value = value}); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.Features.Attack.ProjectileType ProjectileTypeC => GetComponent<Assets._Project.Develop.Runtime.Gameplay.Features.Attack.ProjectileType>();

		public Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<Assets._Project.Develop.Runtime.Gameplay.Features.Attack.Shoot.ProjectileTypes> ProjectileType => ProjectileTypeC.Value;

		public bool TryGetProjectileType(out Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<Assets._Project.Develop.Runtime.Gameplay.Features.Attack.Shoot.ProjectileTypes> value)
		{
			bool result = TryGetComponent(out Assets._Project.Develop.Runtime.Gameplay.Features.Attack.ProjectileType component);
			if(result)
				value = component.Value;
			else
				value = default(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<Assets._Project.Develop.Runtime.Gameplay.Features.Attack.Shoot.ProjectileTypes>);
			return result;
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddProjectileType()
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Attack.ProjectileType() { Value = new Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<Assets._Project.Develop.Runtime.Gameplay.Features.Attack.Shoot.ProjectileTypes>() }); 
		}

		public Assets._Project.Develop.Runtime.Gameplay.EntitiesCore.Entity AddProjectileType(Assets._Project.Develop.Runtime.Utilities.Reactive.ReactiveVariable<Assets._Project.Develop.Runtime.Gameplay.Features.Attack.Shoot.ProjectileTypes> value)
		{
			return AddComponent(new Assets._Project.Develop.Runtime.Gameplay.Features.Attack.ProjectileType() {Value = value}); 
		}
